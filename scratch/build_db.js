...
const database = {
    inventory: [
        ...
        { id: 'ex_dm', name: 'Kashmiri Dum Aloo', category: 'Main', price: 0, active: true, cal: 210, protein: 4, carbs: 28, fat: 9, allergens: ['Dairy'], desc: 'Baby potatoes cooked in a rich fennel and ginger flavored yogurt gravy.' },
        ...
        { id: 'm1', name: 'Dal Bukhara', category: 'Main', price: 0, active: true, cal: 320, protein: 12, carbs: 28, fat: 16, allergens: ['Dairy'], desc: 'Signature black lentils slow-cooked overnight with fresh cream and white butter.' },
    ...
    cms: {
        ...
        hero_video: '/uploads/WhatsApp Video 2026-06-03 at 20.12.56.mp4'
    }
};

const filePath = path.join(__dirname, '..', 'database.json');
fs.writeFileSync(filePath, JSON.stringify(database, null, 4));
console.log('Database.json successfully rebuilt with only real dishes and zeroed leads!');
